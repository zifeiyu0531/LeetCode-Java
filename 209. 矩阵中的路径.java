...
class Solution_209 {
    ...
    public static void main(String args[]) {
        ...
        char[][] board_1 = { { 'A', 'B', 'C', 'E' }, { 'S', 'F', 'C', 'S' }, { 'A', 'D', 'E', 'E' } };
        char[][] board_2 = { { 'a', 'b' }, { 'c', 'd' } };
        String word_1 = "ABCCED", word_2 = "abcd";
        System.out.println(solution.exist(board_1, word_1));
        System.out.println(solution.exist(board_2, word_2));
    }
}